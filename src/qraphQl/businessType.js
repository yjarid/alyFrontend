...
export const BUSINESS_REVIEWS_LOADMORE = gql`
  query Business($id: ID!, $onlyOwner: Boolean, $published: Boolean, $firstRev: Int, $skipRev: Int) {
    business(id: $id, onlyOwner: $onlyOwner, published: $published) {
      _id
      published
      reviews(first: $firstRev, skip: $skipRev) {
        _id
        text
        rating
        createdAt
